---
title: "Run ONNX model with Intel powered Aaeon UP Squared"
permalink: /docs/up2/
excerpt: "Run ONNX model with Intel powered Aaeon UP Squared"
variable:
  - platform: windows
    name: Windows
  - platform: macos
...
## Run ONNX models with Intel powered Aaeon UP Squared

| **[Intel powered Aaeon UP Squared](https://software.intel.com/en-us/iot/hardware/up-squared-ai-vision-dev-kit){:target="_blank"}** |  |
| :----------- |
