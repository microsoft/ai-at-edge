...
permalink: /docs/ml_tools/
excerpt: "Machine learning tools"
variable:
  - platform: windows
    name: Windows
  - platform: macos
...
[Custom Vision]({{ '/docs/customvision/' | relative_url }}) offers an easy to use UI for creation Vision AI model.
